...
from management.api.statistic import StatisticDashboardView, StatisticInventoryReceivingView, StatisticPromotionView, StatisticRefundView, StatisticSalesCustomerView, StatisticSellView, StatisticStockView
