...
from management.api.statistic import StatisticInventoryReceivingView, StatisticPromotionView, StatisticRefundView, StatisticSalesCustomerView, StatisticSellView
